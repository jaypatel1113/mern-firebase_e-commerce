...
import { getClass, getDollarPrice, numberWithCommas, responseToast } from "../../../utils/features";
                    ...
                    <>
                        ...
                        <article className="shipping-info-card">
                            ...
                            <p>
                                ...
                                {getDollarPrice(subtotal)}
                            </p>
                            <p>
                                Shipping Charges: ₹{" "}
                                {numberWithCommas(shippingCharges)} ~ ${" "}
                                {getDollarPrice(shippingCharges)}
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                {getDollarPrice(discount)}
                            </p>
                            <p>
                                Total: ₹ {numberWithCommas(total)} ~ ${" "}
                                {getDollarPrice(total)}
                            </p>
